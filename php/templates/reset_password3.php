...
<div class="tsl_login_css tsl_reset_pass_modal tsl-popup-container tsl-popup-lg">
    <div class="tsl_wrapper">
        <div class="tsl_inside">
            <?php if($header_img != "") : ?>
                <img src="<?php echo esc_url($header_img); ?>" title="<?php esc_attr_e("Reset password form", "tipster_script_login"); ?>" alt="<?php esc_attr_e("Reset password form", "tipster_script_login"); ?>" />
            <?php endif; ?>
        </div>
        <div class="tsl_inside_content">
            ...
            <div class="tsl-popup-body">
                <div id="custom-reset-password">
                    ...
                    <label for="new-password"><?php esc_html_e("New password", "tipster_script_login"); ?></label>
                    <input type="password" id="new-password" class="input" required>
                    <p class="tsl_password_hint"><?php esc_html_e('Hint: The password should be at least twelve characters long. To make it stronger, use upper and lower case letters, numbers, and symbols like ! " ? $ % ^ & ).', 'tipster_script_login'); ?></p>
                    <button type="button" id="save-password-submit" class="button button-primary"><?php esc_html_e("Save Password", "tipster_script_login"); ?></button>
                </div>
                ...
                <p class="tsl_reset_pass_success"></p>
            </div>
        </div>
    </div>
</div>