...
<div class="tsl_login_css tsl_login_modal tsl-popup-container tsl-popup-lg">
    <div class="tsl_wrapper">
        <div class="tsl_inside">
            <?php if($header_img != "") : ?>
                <img src="<?php echo esc_url($header_img); ?>" title="<?php esc_attr_e("Login form", "tipster_script_login"); ?>" alt="<?php esc_attr_e("Login form", "tipster_script_login"); ?>" />
            <?php endif; ?>
        </div>
